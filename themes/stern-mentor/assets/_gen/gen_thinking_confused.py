...
for i in range(N_FRAMES):
    ...
    rot = -5 + 3 * math.sin(angle)
    new_svg = SRC.replace('<g id="body-js" transform="rotate(-5 7.5 4)">',
...
save_apng(frames, str(ASSETS / "thinking-confused.apng"), durations=450, loop=0)
